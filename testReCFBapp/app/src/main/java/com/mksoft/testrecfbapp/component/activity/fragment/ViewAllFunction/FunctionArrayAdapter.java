...
import com.mksoft.testrecfbapp.Repository.Data.TagData;
...
public class FunctionArrayAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    ArrayList<FunctionArray> items = new ArrayList<FunctionArray>();
    Context context;
    MainActivity mainActivity;
    public FunctionArrayAdapter(Context context, MainActivity mainActivity){
    ...
    public void refreshItem(ArrayList<FunctionArray> items){
        this.items = items;
